...
var FormVue2 = {
  ...
  created: function created() {
    ...
    this.form.values = kendo_vue_common_1.clone(this.$props.initialValues);
  },
  ...
  methods: {
    ...
    getErrors: function getErrors() {
      ...
      if (formErrors) {
        kendo_vue_common_1.cloneObject(this.formErrors(), errors);
      }
    ...
    resetForm: function resetForm() {
      this.form.values = kendo_vue_common_1.clone(this.$props.initialValues);
      this.id = kendo_vue_common_1.guid();
