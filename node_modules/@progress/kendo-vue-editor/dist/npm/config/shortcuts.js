...
exports.getShortcuts = function (settings) {
  ...
  var shortcutsSettings = __assign(__assign(__assign(__assign({
    'Mod-b': function ModB(state, dispatch) {
      return kendo_editor_common_1.toggleInlineFormat(toolsSettings.bold || bold)(state, dispatch);
    },
    'Mod-i': function ModI(state, dispatch) {
      return kendo_editor_common_1.toggleInlineFormat(toolsSettings.italic || italic)(state, dispatch);
    },
    'Mod-u': function ModU(state, dispatch) {
      return kendo_editor_common_1.toggleInlineFormat(toolsSettings.underline || underline)(state, dispatch);
    },
    ...
    'Tab': kendo_editor_common_1.goToNextCell(1),
    'Shift-Tab': kendo_editor_common_1.goToNextCell(-1)
  });
