 ...
 */
export declare const cleanMarks: (tr: Transaction<any>, { except }: {
    except?: MarkType<any>[];
}) => void;
/**
...
export declare const styleValue: (mark: Mark<any>, style: {
    name: string;
    value: RegExp;
}) => string;
/**
 ...
 */
export declare const selectionMarks: (state: EditorState<any>, markType: MarkType<any>) => Mark<any>[];
/**
 ...
 */
export declare const getActiveMarks: (state: EditorState<any>, markType: MarkType<any>) => ActiveMarks;
