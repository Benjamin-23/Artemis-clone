 ...
 * @returns DocumentFragment
 */
export declare const pmDocToFragment: (doc: ProseMirrorNode<any>) => DocumentFragment;
/**
 ...
 */
export declare const domToPmDoc: (dom: Node, schema: Schema<any, any>, parseOptions: ParseOptions<any>) => ProseMirrorNode<any>;
/**
 ...
 */
export declare const parseContent: (content: string, schema: Schema<any, any>, parseOptions?: ParseOptions<any>) => ProseMirrorNode<any>;
/**
 ...
 */
export declare const getHtml: (state: EditorState<any> | {
