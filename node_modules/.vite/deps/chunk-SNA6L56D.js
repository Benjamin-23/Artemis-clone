...
function templateRendering(template, listeners) {
  ...
  var scopedSlot = gh ? this.$slots[template] || (template.toLowerCase ? this.$slots[template.toLowerCase()] : null) : this.$scopedSlots[template] || (template.toLowerCase ? this.$scopedSlots[template.toLowerCase()] : null);
...
function getTemplate(_a) {
  ...
  if (template.type === "slot") {
    ...
    return h(template.render, componentOptions, gh ? function() {
      return [defaultSlots];
    } : [defaultSlots]);
  }
}
...
}, _defineProperty(_DraggableVue, "setup", !gh2 ? void 0 : function() {
  var v3 = !!gh2;
  return {
    v3
  };
...
//# sourceMappingURL=chunk-SNA6L56D.js.map
