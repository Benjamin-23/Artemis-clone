...
import {
  ...
  kendoThemeMaps,
  templateRendering,
  validatePackage as validatePackage2
} from "./chunk-MYDXTYQF.js";
import {
  index_esm_exports,
  main_default,
  validatePackage
} from "./chunk-XLNYWJB3.js";
import {
...
var IntlError = function IntlError2(ref9) {
  var name = ref9.name;
  var message = ref9.message;
  if (!name || !message) {
...
function standardNumberFormat(number, options, info) {
  ...
  var ref9 = fractionOptions(options);
  var minimumFractionDigits = ref9.minimumFractionDigits;
  var maximumFractionDigits = ref9.maximumFractionDigits;
...
function parseNumber(value3, locale2, format2) {
  ...
  var ref9 = cleanCurrencyNumber(number, info, formatOptions2);
  var negativeCurrency = ref9.negative;
  var currencyNumber = ref9.number;
...
function validatePackage3(packageMetadata5) {
  if (typeof index_esm_exports !== "undefined") {
    validatePackage(packageMetadata5);
  } else {
    var message = "License activation failed for " + packageMetadata5.name + "\n";
    message += "The @progress/kendo-licensing script is not loaded.\n";
    message += "See " + packageMetadata5.licensingDocsUrl + " for more information.\n";
...
var ProgressBarVue2 = {
  ...
  destroyed: !!gh31 ? void 0 : function() {
...
function copyInputItemWithoutChildren(inputModel) {
  var result = {};
  var text = inputModel.text, url = inputModel.url, icon = inputModel.icon, disabled = inputModel.disabled, cssClass = inputModel.cssClass, cssStyle = inputModel.cssStyle, render40 = inputModel.render, linkRender = inputModel.linkRender, contentRender2 = inputModel.contentRender, data15 = inputModel.data;
  if (text !== void 0) {
    result.text = text;
  }
  if (url !== void 0) {
  ...
  if (render40 !== void 0) {
    result.render = templateRendering.call(this, render40, getListeners.call(this));
  }
...
var MenuItemInternalVue2 = {
  ...
  setup: !gh35 ? void 0 : function() {
    var v3 = !!gh35;
    var kendoAnchorRef = ref8(null);
    return {
      v3,
      kendoAnchorRef
    };
...
var MenuVue2 = {
  ...
  destroyed: !!gh37 ? void 0 : function() {
