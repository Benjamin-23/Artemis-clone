...
import {
  ...
  templateRendering,
  validatePackage
} from "./chunk-MYDXTYQF.js";
import "./chunk-XLNYWJB3.js";
import {
  vue_runtime_esm_bundler_exports
} from "./chunk-G4TRI3LJ.js";
...
var ButtonVue2 = {
  ...
  render: function render(createElement) {
    ...
    var _a = this.$props, togglable = _a.togglable, icon = _a.icon, iconClass = _a.iconClass, imageUrl = _a.imageUrl, imageAlt = _a.imageAlt;
    var defaultSlot = getDefaultSlots(this);
    ...
    return h("button", {
      ...
      role: togglable ? "checkbox" : void 0,
      attrs: this.v3 ? void 0 : {
        role: togglable ? "checkbox" : void 0,
        "aria-disabled": this.$props.disabled || void 0,
        "aria-checked": togglable ? this.currentActive : void 0
      },
      "aria-disabled": this.$props.disabled || void 0,
      "aria-checked": togglable ? this.currentActive : void 0
...
var ChipVue2 = {
  ...
  render: function render4(createElement) {
    ...
    var _b = this.$props, size = _b.size, rounded = _b.rounded, themeColor = _b.themeColor, fillMode = _b.fillMode, look = _b.look, type = _b.type;
    return h("div", {
...
var ChipListVue2 = {
  ...
  render: function render5(createElement) {
    ...
    return h("div", {
      ...
      var chipDefaultRendering = h(Chip, {
        role: "option",
        attrs: this.v3 ? void 0 : {
          role: "option",
          dataItem: item,
...
var FloatingActionButtonItemVue2 = {
  ...
  render: function render6(createElement) {
    ...
    var _a = this.$props, disabled = _a.disabled, id = _a.id, tabIndex = _a.tabIndex, dataItem = _a.dataItem, customProp = _a.customProp;
    var text = dataItem.text, icon = dataItem.icon;
    var item;
...
var position = function(ref7, align, alignOffset, isRtl3) {
  ...
  if (ref7) {
    ...
    var xCenterFab = alignOffset && alignOffset.x !== void 0 ? "calc(50% + " + toStringValues(alignOffset.x) + ")" : "50%";
    var yFab = alignOffset && alignOffset.y !== void 0 ? toStringValues(alignOffset.y) : DEFAULT_OFFSET;
    var yCenterFab = alignOffset && alignOffset.y !== void 0 ? "calc(50% + " + toStringValues(alignOffset.y) + ")" : "50%";
...
var FloatingActionButtonVue2 = {
  ...
  render: function render7(createElement) {
    ...
    var _a = this.$props, align = _a.align, disabled = _a.disabled, icon = _a.icon, iconClass = _a.iconClass, id = _a.id, items2 = _a.items, text = _a.text, tabIndex = _a.tabIndex, accessKey = _a.accessKey, popupSettings = _a.popupSettings;
    ...
    var fabItems = function fabItems2() {
      return items2 && items2.map(function(element4, index) {
        return h(FloatingActionButtonItem, {
          key: index,
          index,
          attrs: this.v3 ? void 0 : {
            index,
    ...
    return h("div", {
      ...
      h("button", {
        ...
        attrs: this.v3 ? void 0 : {
          ...
          "aria-activedescendant": this.focusedIndex >= 0 && items2 ? this.listId + "-" + this.focusedIndex : void 0,
          tabIndex: getTabIndex(tabIndex, disabled),
          accessKey,
          dir: this.currentDir,
          disabled
...
//# sourceMappingURL=@progress_kendo-vue-buttons.js.map
